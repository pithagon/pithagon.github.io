    ...
    return (
        ...
        <Navbar>
            <a className="flex items-center hovesr:opacity-75 ltr:mr-auto rtl:ml-auto" href="/">
                ...
                <span className="x:max-md:hidden x:select-none x:font-extrabold x:ltr:ml-2 x:rtl:mr-2" title="Pithagon.github.io: Gesture Generation Research Community">Pithagon.github.io</span>
            </a>
