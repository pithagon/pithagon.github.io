...
export default function Features({ children,
  ...
  return (
    <div className="mx-auto mb-10 w-[880px] max-w-full px-4 text-center">
      {/* <p className="text-lg mt-6 text-gray-600 md:!text-2xl">{TITLE_WITH_TRANSLATIONS[locale!]}</p> */}

      <div className={styles.features}>
        <Feature
          text={"sdfdsf"} // featureText('lightweight')
          icon={
            <svg
              viewBox="0 0 24 24"
              width="24"
        ...
        />
        <Feature
          text={"sdfsdf"}//featureText('pagination')}
          icon={
            <svg
              viewBox="0 0 24 24"
              width="24"
        ...
        />
        <Feature
          text={"sdfsdf"}//featureText('backendAgnostic')}
          icon={
            <svg
              viewBox="0 0 24 24"
              width="24"
        ...
        />
        <Feature
          text={"sdfsdf"}//featureText('renderingStrategies')}
          icon={
            <svg
              width="24"
              height="24"
        ...
        />
        <Feature
          text={"sdfsdf"}//featureText('typescript')}
          icon={
            <svg
              width="24"
              height="24"
        ...
        />
        <Feature
          text={"sdfsdf"}//featureText('remoteLocal')}
          icon={
            <svg
              width="24"
              height="24"
